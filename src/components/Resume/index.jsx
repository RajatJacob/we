...
this.onResetClick=this.onResetClick.bind(this);
	...
	render()
	{
		return(
			...
			<label>
			First Name 
			<input  value="input" name="fname" type="text" required="required" value={this.state.fname} onChange={this.handleChange}/>
			</label>
			<br/>
         <label>
         Last Name 
         ...
         <label>
         Date of Birth
         <input  value="input" name="date" type="date" required="required" value={this.state.date} onChange={this.handleChange}/>
         </label>
         <br/>
			<label>
			Gender
			M<input value="input" name="gender" type="radio" id="radios-0" value="1" checked="checked"  onChange={this.handleChange}/>
