	...
	render()
	{
		...
		return(
			<div className="Ayurveda">
				...
				<div className="Ayur">
				<p className="info">Ayurveda Basic Course builds foundation in Basic Ayurveda concepts/ terms, introduces Doshas, concepts related to five elements (Panchmahabhuta), Rasas (taste), Sapta Dhatus( Seven Tissues), Agni, Malas, Daily Regimens and other foundation concepts to build good base for other further studies.
				<br/>This course helps you to understand intermediate to advanced procedures in Ayurveda like concept of disease and Panchkarma, pathology of diseases, treatment plan based on body constitution and type (Dosha), details of Panchkarma methods and understanding.
				<br/>
				<h4>Various modules of the course</h4>
				<ul>
